...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('scroll', function () {
    ...
    var smokeElements = document.querySelectorAll('.smoke-bg');
    smokeElements.forEach(function (element, index) {
  ...
  document.querySelectorAll('.animate-fade-in, .animate-fade-in-delay, .animate-fade-in-delay-2').forEach(function (el) {
    el.style.opacity = '0';
  ...
  document.querySelectorAll('.btn-premium, .btn-secondary').forEach(function (button) {
  ...
  var criticalImages = ['/images/Car3d.png'];
  ...
  document.addEventListener('mousemove', function (e) {
    var cursor = document.querySelector('.premium-cursor');
    if (cursor) {
  ...
  var mainHeading = document.querySelector('.gradient-text');
